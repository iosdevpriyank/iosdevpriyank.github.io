...
class GitHubIntegration {
    ...
    async fetchRepositories() {
        ...
        const excludedRepos = ['iosdevpriyank.github.io'];
        return repos ? repos.filter(repo => !repo.fork && !repo.private && !excludedRepos.includes(repo.name)) : [];
    }
    ...
    getLanguageIcon(language) {
        ...
        return icons[language] || 'simple-icons:github';
    }
...
class MediumIntegration {
    constructor(username = '@iosdev.priyank') {
        this.username = username;
        this.cache = new Map();
...
class PortfolioApp {
    constructor() {
        ...
        this.medium = new MediumIntegration('@iosdev.priyank');
        ...
        return `
            <div class="project-card" data-type="${language.toLowerCase()}">
                <div class="project-image" style="background: var(--gradient-primary); display: flex; align-items: center; justify-content: center; height: 180px;">
                    <iconify-icon icon="${icon}" style="font-size: 4rem; opacity: 0.8; color: white;"></iconify-icon>
                </div>
    ...
    setupThemeToggle() {
        ...
        const themeToggle = document.querySelector('.theme-toggle') || document.querySelector('.main-nav a[href="#"]');
        if (themeToggle) {
    ...
    toggleTheme() {
        ...
        const button = document.querySelector('.theme-toggle') || document.querySelector('.main-nav a[href="#"]');
        if (button) {
